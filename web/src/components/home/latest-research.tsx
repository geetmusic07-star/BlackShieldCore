      ...
      <div className="grid gap-10 lg:grid-cols-[1.3fr_1fr]">
        <Reveal>
          ...
          >
            ...
            <div className="mt-8 flex items-center gap-2 text-[12px] font-mono text-[color:var(--bsc-text-3)]">
              <span>
                {featuredResearch.minutes} min read ·{" "}
                {new Date(featuredResearch.date).toLocaleDateString(undefined, {
                  month: "short",
                  year: "numeric",
                })}
              </span>
          ...
          {recentPosts.map((post, i) => (
            <Reveal key={post.slug} delay={0.05 * i}>
              ...
              >
                ...
                <div className="mt-3 flex items-center justify-between text-[11px] font-mono text-[color:var(--bsc-text-3)]">
                  <span>
